...
public class StaffRodTransmutative extends StaffRod {

    private ArrayList<ResourceLocation> textures = new ArrayList<ResourceLocation>();
    private int[] frames = { 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 5, 5, 5, 5, 5, 5, 6, 7, 8, 9, 10, 10, 10, 10, 10, 10, 11, 12,
        13, 14, 15, 15, 15, 15, 15, 15, 16, 17, 18, 19, 20, 20, 20, 20, 20, 20, 21, 22, 23, 24, 25, 25, 25, 25, 25, 25,
        26, 27, 28, 29 };

    public StaffRodTransmutative(String tag, int capacity, ItemStack item, int craftCost, IWandRodOnUpdate onUpdate,
