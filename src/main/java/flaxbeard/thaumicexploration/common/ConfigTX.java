...
public class ConfigTX {
    ...
    public static void loadConfig(FMLPreInitializationEvent event) {
        ...
        potionTaintWithdrawlID = config.get("Potion", "Taint Withdrawl", 32)
            .getInt();
        potionBindingID = config.get("Potion", "Binding", 31)
            .getInt();

        enchantmentBindingID = config.get("Enchantment", "Binding", 77)
            .getInt();
        enchantmentNightVisionID = config.get("Enchantment", "Night Vision", 78)
            .getInt();
        enchantmentDisarmID = config.get("Enchantment", "Disarming", 79)
            .getInt();

        enchantmentBindingEnable = config.get("Enchantment", "Binding enabled", true)
            .getBoolean(true);
        enchantmentNVEnable = config.get("Enchantment", "Night Vision enabled", true)
            .getBoolean(true);
        enchantmentDisarmEnable = config.get("Enchantment", "Disarm enabled", true)
            .getBoolean(true);
        ...
        prefix = config.get("Miscellaneous", "Display [TX] prefix before Thaumic Exploration research", true)
            .getBoolean(true);
        breadWand = config.get("Easter Eggs", "Enable Thaumic Frenchurgy", false)
            .getBoolean(false);
        ...
        allowBoundInventories = config.get("Miscellaneous", "Enable bound inventories", true)
            .getBoolean(true);
        allowReplication = config.get("Miscellaneous", "Enable Thaumic Replicator", true)
            .getBoolean(true);
        allowCrucSouls = config.get("Miscellaneous", "Enable Crucible of Souls", true)
            .getBoolean(true);
        allowThinkTank = config.get("Miscellaneous", "Enable Think Tank", true)
            .getBoolean(true);
        allowFood = config.get("Miscellaneous", "Enable Talisman of Nourishment", true)
            .getBoolean(true);
        allowUrnLava = config.get("Miscellaneous", "Enable Everburn Urn", true)
            .getBoolean(true);
        allowUrnWater = config.get("Miscellaneous", "Enable Everfull Urn", true)
            .getBoolean(true);
        ...
        allowMechanist = config.get("Miscellaneous", "Enable Mechanist's Wand Caps", true)
            .getBoolean(true);
        allowEnchants = config.get("Miscellaneous", "Enable TX Enchantments", true)
            .getBoolean(true);
        allowTainturgy = config.get("Miscellaneous", "Enable Wispy Dreamcatcher", true)
            .getBoolean(true);
        ...
        allowEverfullUrnFillNearby = config.get(
            ...
            true)
            .getBoolean(true);
        allowThaumcraftCrucibleRefill = config
            .get("EverfullUrn", "Allow the Everfull Urn to fill up Thaumcraft Crucibles", true)
            .getBoolean(true);
        allowThaumcraftSpaRefill = config.get("EverfullUrn", "Allow the Everfull Urn to fill up Thaumcraft Spas", true)
            .getBoolean(true);
        allowVanillaCauldronRefill = config
            .get("EverfullUrn", "Allow the Everfull Urn to fill up vanilla Cauldrons", true)
            .getBoolean(true);
        allowBotaniaApothecaryPetalRefill = config
            .get("EverfullUrn", "Allow the Everfull Urn to fill up Botania Petal Apothecaries", true)
            .getBoolean(true);
        allowWitcheryCauldronRefill = config
            .get("EverfullUrn", "Allow the Everfull Urn to fill up Witchery Cauldrons", true)
            .getBoolean(true);
        allowWitcheryKettleRefill = config
            .get("EverfullUrn", "Allow the Everfull Urn to fill up Witchery Kettles", true)
            .getBoolean(true);
