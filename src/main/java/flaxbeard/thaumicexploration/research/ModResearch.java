...
public final class ModResearch {
    ...
    public static void initResearch() {
        ...
        research
            .setPages(new ResearchPage("1"), new ResearchPage((IArcaneRecipe[]) scer.toArray(new IArcaneRecipe[0])));
        ...
        research = new TXResearchItem(
            ...
            -10,
            1,
            new ItemStack(Items.rotten_flesh)).setParents("TXTALLOW")
                .setParentsHidden("TALLOW")
                .setHidden()
                .setSecondary()
                .setItemTriggers(new ItemStack[] { new ItemStack(Items.rotten_flesh, 1, 32767) })
                .registerResearchItem();
        ...
        research = new TXResearchItem(
            "SOULBRAZIER",
            "TX",
            new AspectList().add(Aspect.AURA, 3)
        ...
        research = new TXResearchItem(
            ...
            -9,
            1,
            new ItemStack(ThaumicExploration.floatCandle)).setParents("TXTALLOW", "TALLOW")
                .setConcealed()
                .setSecondary()
                .registerResearchItem();
        ...
        if (ConfigTX.allowThinkTank) {
            research = new TXResearchItem(
                "THINKTANK",
                "TX",
                new AspectList().add(Aspect.UNDEAD, 4)
                    .add(Aspect.MIND, 8)
                    .add(Aspect.SENSES, 6)
                    .add(Aspect.GREED, 2),
                -1,
        ...
        if (ConfigTX.allowUrnWater) {
            ...
            if (ConfigTX.allowUrnLava) {
                research = new TXResearchItem(
                    ...
                    -11,
                    1,
                    new ItemStack(ThaumicExploration.everburnUrn)).setParents("URN")
                        .setParentsHidden("ARCANEEAR")
                        .setConcealed()
                        .registerResearchItem();
        ...
        research = new TXResearchItem(
            ...
            new ItemStack(ThaumicExploration.stabilizerBelt))
                .setParents("INFUSION", "TXINFUSION", "HOVERHARNESS", "TXHOVERHARNESS")
                .setConcealed()
                .registerResearchItem();
        ...
        if (ConfigTX.allowReplication) {
            research = new TXResearchItem(
                "REPLICATOR",
                "TX",
                new AspectList().add(Aspect.CRAFT, 10)
        ...
        if (ConfigTX.allowCrucSouls) {
            research = new TXResearchItem(
                "CRUCSOULS",
                "TX",
                new AspectList().add(Aspect.DEATH, 7)
                    .add(Aspect.HUNGER, 7)
                    .add(Aspect.SOUL, 8),
                5,
                -7,
                ...
                new ItemStack(ThaumicExploration.crucibleSouls))
                    .setParents("DISTILESSENTIA", "TXINFUSION", "TXDISTILESSENTIA")
                    .setParentsHidden("BRAINCURE", "INFUSION")
                    .setConcealed()
                    .registerResearchItem();
        ...
        if (ConfigTX.allowFood) {
            research = new TXResearchItem(
                "TALISMANFOOD",
                "TX",
                new AspectList().add(Aspect.HUNGER, 5)
                    .add(Aspect.FLESH, 4)
                    .add(Aspect.CROP, 4),
                -1,
                -11,
        ...
        if (ConfigTX.allowBoots) {
            research = new FauxResearchItem(
                ...
                1,
                -4,
                getOriginalItem("BOOTSTRAVELLER", "ARTIFICE")).setParents("TXINFUSION")
                    .registerResearchItem();
            research = new TXResearchItem(
                "METEORBOOTS",
                "TX",
                new AspectList().add(Aspect.FIRE, 5)
                    .add(Aspect.ENERGY, 5)
                    .add(Aspect.TRAVEL, 10)
                    .add(Aspect.FLIGHT, 5),
                2,
                -1,
                2,
                new ItemStack(ThaumicExploration.bootsMeteor))
                    .setParents("TXBOOTSTRAVELLER", "BOOTSTRAVELLER", "FOCUSFIRE")
                    .setParentsHidden("INFUSION")
                    .setConcealed()
                    .registerResearchItem();
            ...
            research = new TXResearchItem(
                ...
                new ItemStack(ThaumicExploration.bootsComet))
                    .setParents("TXBOOTSTRAVELLER", "BOOTSTRAVELLER", "FOCUSFROST")
                    .setParentsHidden("INFUSION")
                    .setConcealed()
                    .registerResearchItem();
        ...
        if (ConfigTX.allowSojourner) {
            research = new TXResearchItem(
                "CAP_SOJOURNER",
                "TX",
                new AspectList().add(Aspect.EXCHANGE, 5)
                    .add(Aspect.ENERGY, 5)
                    .add(Aspect.AURA, 8)
                    .add(Aspect.GREED, 5)
                    .add(Aspect.TOOL, 3),
                ...
                new ItemStack(ThaumicExploration.sojournerCap)).setParents("TXCAP_thaumium", "CAP_thaumium")
                    .setParentsHidden("WANDPED")
                    .setConcealed()
                    .registerResearchItem();
            research
                .setPages(new ResearchPage("1"), arcaneRecipePage("UNCHARGEDSOJOURNER"), infusionPage("CAP_SOJOURNER"));
        }
        ...
        if (ConfigTX.allowMechanist) {
            research = new TXResearchItem(
                "CAP_MECHANIST",
                "TX",
                new AspectList().add(Aspect.MECHANISM, 5)
                    .add(Aspect.ENERGY, 5)
                    .add(Aspect.AURA, 8)
                    .add(Aspect.GREED, 5)
                    .add(Aspect.TOOL, 3),
                ...
                new ItemStack(ThaumicExploration.mechanistCap)).setParents("TXCAP_thaumium", "CAP_thaumium")
                    .setParentsHidden("NODETAPPER2")
                    .setConcealed()
                    .registerResearchItem();
            research
                .setPages(new ResearchPage("1"), arcaneRecipePage("UNCHARGEDMECHANIST"), infusionPage("CAP_MECHANIST"));
        }

        ResourceLocation taint = new ResourceLocation("thaumicexploration:textures/tabs/taintResearch2.png");
        research = new TXResearchItem("TAINTBASICS", "TX", new AspectList(), -9, 0, 0, taint).setAutoUnlock()
            .setStub()
            .setRound()
            .registerResearchItem();
        ...
        if (ConfigTX.allowTainturgy) {
            research = new TXResearchItem(
                ...
                2,
                2,
                new ItemStack(ThaumicExploration.charmNoTaint)).setParents("TAINTBASICS")
                    .setHidden()
                    .setAspectTriggers(new Aspect[] { Aspect.TAINT })
                    .registerResearchItem();
        ...
        research = new TXResearchItem(
            ...
            2,
            2,
            new ItemStack(ThaumicExploration.tentacleRing)).setParents("TAINTBASICS")
                .setHidden()
                .setEntityTriggers(new String[] { "Thaumcraft.Taintacle" })
                .registerResearchItem();
        ...
        if (ConfigTX.allowEnchants) {
            ...
            if (ConfigTX.enchantmentBindingEnable) {
                research = new TXResearchItem(
                    ...
                    new ResourceLocation("thaumicexploration:textures/tabs/binding.png"))
                        .setParents("TXINFUSIONENCHANTMENT", "INFUSIONENCHANTMENT")
                        .setConcealed()
                        .setSecondary()
                        .registerResearchItem();
                research.setPages(new ResearchPage("1"), infusionEnchantPage("ENCHBINDING"));
            ...
            if (ConfigTX.enchantmentDisarmEnable) {
                research = new TXResearchItem(
                    "ENCHDISARM",
                    "TX",
                    new AspectList().add(Aspect.SLIME, 6)
                        .add(Aspect.TRAP, 4)
                        .add(Aspect.WEAPON, 4),
                    -3,
                    -4,
        ...
        research = new TXResearchItem(
            "ROD_TRANSMUTATION",
            "TX",
            new AspectList().add(Aspect.TOOL, 8)
                .add(Aspect.MAGIC, 8)
        ...
        research = new TXResearchItem(
            ...
            1,
            3,
            new ItemStack(ThaumicExploration.necroStaffCore)).setParents("ROD_greatwood_staff", "TXROD_greatwood_staff")
                .setConcealed()
                .registerResearchItem();
        ...
        research = new TXResearchItem(
            ...
            new ItemStack(ThaumicExploration.trashJar)).setConcealed()
                .setParents("TXJARVOID", "JARVOID", "INFUSION", "TXINFUSION")
                .registerResearchItem();
    ...
    private static void registerResearchPages() {
        ...
        ResearchCategories
            .registerCategory("TX", new ResourceLocation("thaumicexploration:textures/tabs/txTab.png"), background2);
    }
